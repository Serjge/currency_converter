import { FC, KeyboardEvent, memo, ReactElement, useRef, useState } from 'react';
...
export const Select: FC<SelectType> = memo(
  ({ currencies, currentCurrency, setCurrentCurrency }): ReactElement => {
    ...
    return (
      <SelectBody ref={selectRef} onKeyUp={onKeyUp}>
